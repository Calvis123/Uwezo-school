  ...
  const loadClasses = useCallback(async () => {
    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        // Demo data
        setClasses([
          { id: '1', name: 'Grade 1 A', level: 'GRADE_1', stream: 'A', capacity: 40, status: 'ACTIVE', studentCount: 32 },
          { id: '2', name: 'Grade 1 B', level: 'GRADE_1', stream: 'B', capacity: 40, status: 'ACTIVE', studentCount: 35 },
          { id: '3', name: 'Grade 2 A', level: 'GRADE_2', stream: 'A', capacity: 40, status: 'ACTIVE', studentCount: 28 },
          { id: '4', name: 'Grade 3 A', level: 'GRADE_3', stream: 'A', capacity: 35, status: 'ACTIVE', studentCount: 30 },
          { id: '5', name: 'Nursery A', level: 'NURSERY', stream: 'A', capacity: 30, status: 'ACTIVE', studentCount: 25 },
          { id: '6', name: 'PP1 A', level: 'PP1', stream: 'A', capacity: 25, status: 'ACTIVE', studentCount: 20 },
          { id: '7', name: 'JSS 1 A', level: 'JSS_1', stream: 'A', capacity: 45, status: 'ACTIVE', studentCount: 38 },
          { id: '8', name: 'Grade 8 A', level: 'GRADE_8', stream: 'A', capacity: 45, status: 'INACTIVE', studentCount: 0 },
        ])
      }
    } catch {
      setClasses([])
