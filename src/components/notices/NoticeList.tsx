      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {notices.map((notice, index) => (
            ...
            >
              <Card
                className="shadow-sm border-slate-200/60 hover:shadow-md transition-shadow cursor-pointer"
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {notice.category === 'URGENT' && (
                          <Badge variant="secondary" className="text-[10px] bg-red-50 text-red-600 animate-pulse">
                            URGENT
                          </Badge>
                        )}
                      </div>
