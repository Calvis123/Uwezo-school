  ...
  const loadDashboard = async () => {
    ...
    try {
      const [dashRes, childrenRes] = await Promise.all([
        parentApi.dashboard(user.id),
        parentApi.children(user.id),
      ])
                        ...
                        return (
                          <div>
                            ...
                            <div className="flex items-center gap-4 mb-4 text-xs">
                              ...
                              <div className="flex items-center gap-1.5">
                                <div className="h-3 w-3 rounded-full bg-slate-200 dark:bg-slate-600" />
                            ...
                            <div className="grid grid-cols-7 gap-1">
                              ...
                              {calendarDays.map((day, idx) => {
                                ...
                                if (isWeekend || isFuture) dotColor = 'bg-slate-100 dark:bg-slate-800'
                                ...
                                return (
                                  ...
                                  >
                                    <span className={cn(
                                      ...
                                      isWeekend || isFuture ? 'text-slate-300 dark:text-slate-600' : 'text-slate-600 dark:text-slate-300'
                                    )}>
                                      {day}
                                    </span>
